    ...
    <div class="modal-dialog modal-lg">
        <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <form id="register-form" action="" method="post" role="form" style="display: none;">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <div class="form-group">
                                            <label>Bundesland auswählen</label><font color="red">*</font><br/>
                                            <select name="name_dist" id="name_dist" class='form-control'>
                                                ...
                                                <?php foreach ($get_districts as $dis) { ?>
                                                    <option value="<?php echo $dis['id']; ?>"><?php echo $dis['name_dr']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        <div class="form-group">
			...
			<label class="info-disc"><span><i class="fa fa-info-circle" aria-hidden="true"></i></span><font><?php _e("BoroughNotNeeded"); ?></font></label>
                                        ...
                                        <div class="form-group">
                                            <label for="agreeeMail"><input type="checkbox" tabindex="3" class="" name="agreeeMail" id="agreeeMail"  style="margin-right: 10px;" value="1"><?php _e("I agree eMail2"); ?></label> 
			<p style="color:red;"><?php _e("NoeMailWarning2"); ?><p>   
                                        </div>
                                 <div class="form-group">
...
<footer>
    ...
    <div class="footer-bootom">
        <a href="http://www.hashsoftware.com/" target="_blank"><span><?php _e("Design by : Hash Software"); ?></span></a>
...
<script type="text/javascript" id="cookieinfo"
	...
	data-moreinfo="https://ausgezeichnet.cc/datenschutzerklaerung.pdf"
	data-bg="#645862"
	data-fg="#FFFFFF"
	data-link="#F1D600"
