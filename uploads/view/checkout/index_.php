...
<form action='<?php echo make_url("checkout"); ?>' method='post'>
    <div class="container">
        <div class="row">
                ...
                <div class="chech-out">
                    ...
                    <?php } else { ?>
                        <div class="spot-a" id="billing_container" style="display:block">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <lebel><?php _e("Permanent Address"); ?></lebel>
                                    <input type="text" class="feild-a" name='paddr' value="<?php echo isset($app['POST']['paddr']) ? $app['POST']['paddr'] : $cart_detail->billing_address2; ?>">
                                </div>
                    ...
                    <div class="spot-a" id="shipping_container" style="display:<?php echo $shipping_form; ?>">
                        ...
                        <div class="form-group">
                            <div class="col-sm-13">
                                <lebel><?php _e("Company"); ?></lebel>
                                <input type="text" class="feild-a" name='s_company' value="<?php echo isset($app['POST']['s_fname']) ? $app['POST']['s_company'] : $cart_detail->shipping_company; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-6">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <lebel><?php _e("Permanent Address"); ?></lebel>
                                <input type="text" class="feild-a" name='ps_addr' value="<?php echo isset($app['POST']['ps_addr']) ? $app['POST']['ps_addr'] : $cart_detail->shipping_address2; ?>">
                            </div>
                    ...
                    <div class="form-group">
                        <lebel><?php _e("Order Comment"); ?></lebel>
                    ...
                    <div class="y-order">
                        ...
                        <table>
                            ...
                            <tr class="total">
                                <td><h4><strong><?php _e("TotalDisc"); ?></h4></strong></td>
                                <td><h4><strong><?php show_price(get_total()*0.8); ?></h4></strong></td>
                            </tr>
                            <tr class="total">
                                <td><?php _e("ShippingCost"); ?></td>
                                <td><?php show_price(3.90); ?></h4></td>
                            </tr>
                            <tr>
                                <td><h4><?php _e('TotalDiscounted'); ?></h4></td>
                                <td><h4><strong><?php echo show_price(get_total() * 0.8+3.90); ?></h4></td>
                            </tr>
