<div class="row">
    <div class="col-sm-12">
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-red-sunglo">
                    ...
                    <span class="caption-subject bold uppercase"> Manage Misc Items</span>
                </div>
            ...
            <div class="srch-bar">
                ...
                <form method="GET"  action=" <?php  echo app_url('miscitems','list','list')?>">
                ...
                <!--<input type="hidden" value ="<?php //echo app_url('miscitems','list','list',array('content'=>$text))?>">-->
		...
		<td>  <div class="img-uper">
                                ...
                                <td>
                                    <a class="btn btn-info btn-sm" href="<?php echo app_url('miscitems','edit','edit',array('id'=>$batch->id));?>" title="Edit batch"><i class="fa fa-pencil"></i> Edit</a>&nbsp;&nbsp;
                                    <a class="btn btn-danger btn-sm" href="<?php echo app_url('miscitems','delete_batch','list',array('del'=>$batch->id));?>"onclick="return confirm('Are you sure you want to delete this category?');" title="Delete Category"><i class="fa fa-trash"></i> Delete</a>&nbsp;&nbsp;
