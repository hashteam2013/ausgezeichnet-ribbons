        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-red-sunglo">
                    ...
                    <span class="caption-subject bold uppercase"> Add district</span>
                </div>
            ...
            <div class="portlet-body form">
                <div class="row">
                    <div class="col-sm-8">
                        <form role="form" action="<?php app_url('districts','add','add');?>" method="POST">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input type="number" name='max_ribbon' value=" <?php echo isset($app['POST']['max_ribbon'])?$app['POST']['max_ribbon']:'';?>" min="0" id="number"> 
                                </div>
                                <div class="row">
                                <div class="col-sm-4">
                                   <div class="form-group">
                                ...
                                <div class="form-actions">
                                    <button type="submit" name="add" class="btn blue">Add District</button>
