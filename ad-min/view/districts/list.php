        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-red-sunglo">
                    ...
                    <span class="caption-subject bold uppercase"> Manage Districts</span>
                </div>
                    ...
                    <div class="col-sm-12">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><?php echo $district->max_ribbon;?></td>
                                <td><?php if ($district->is_allowed =='1'){ echo 'High'; } 
                                else { echo 'Low' ;}
                                ?></td>
...
<!--                                <td><?php //if ($district->is_deleted =='1'){ echo 'Deleted'; } 
                                ...
                                ?></td>-->
                                <td>
                                    <a class="btn btn-info btn-sm" href="<?php echo app_url('districts','edit','edit',array('id'=>$district->id));?>" title="Edit district"><i class="fa fa-pencil"></i> Edit</a>&nbsp;&nbsp;
                                    <a class="btn btn-danger btn-sm" href="<?php echo app_url('districts','delete_district','list',array('del'=>$district->id));?>"onclick="return confirm('Are you sure you want to delete this district?');" title="Delete district"><i class="fa fa-trash"></i> Delete</a>&nbsp;&nbsp;
