                    ...
                    <div class="col-sm-12">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><?php echo $category->name_dr;?></td>
                                <td><?php echo $category->position;?></td>
                                <td><?php if ($category->is_active =='1'){ echo 'Active'; } 
                                else { echo 'Not Active' ;}
                                ?></td>
                                <td>
                                    <a class="btn btn-info btn-sm" href="<?php echo app_url('categories','edit','edit',array('id'=>$category->id));?>" title="Edit Category"><i class="fa fa-pencil"></i> Edit</a>&nbsp;&nbsp;
                                    <a class="btn btn-danger btn-sm" href="<?php echo app_url('categories','delete_category','list',array('del'=>$category->id));?>" onclick="return confirm('Are you sure you want to delete this category?');" title="Delete Category"><i class="fa fa-trash"></i> Delete</a>&nbsp;&nbsp;
