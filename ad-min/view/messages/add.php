                    ...
                    <div class="col-sm-8">
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" value="<?php echo isset($app['POST']['name'])?$app['POST']['name']:'';?>" class="form-control" placeholder="Message subject"> 
                                    <textarea name="message" rows="20" cols="100">Insert Message  </textarea>
                                </div>

                                <div class="form-actions">
                                    <button type="submit" name="add" class="btn blue">Add Message</button>
