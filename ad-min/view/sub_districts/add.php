        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-red-sunglo">
                    ...
                    <span class="caption-subject bold uppercase"> Add sub district</span>
                </div>
            ...
            <div class="portlet-body form">
                <div class="row">
                    <div class="col-sm-8">
                        ...
                        <form role="form" action="<?php app_url('sub_districts','add','add');?>" method="POST">
                            <div class="form-body">
                                ...
                                <div class="form-actions">
                                    <button type="submit" name="add" class="btn blue">Add Sub District</button>
