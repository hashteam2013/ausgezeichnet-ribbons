    ...
    <div class="col-sm-12">
        ...
        <div class="portlet light bordered partation">
                   ...
                   <input type="hidden" name="batch" id="batch" class="batch" value="<?php echo $app['GET']['id']; ?>" />
                    <div class="col-sm-8">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <label>Confirm_Comment</label>
                                    <input type="text" name="confirm_comment" value="<?php echo isset($app['POST']['confirm_comment'])?$app['POST']['desdr']:$batches->confirm_comment;?>" class="form-control" placeholder="confirm_comment"> 
                                </div>
			...
			?>
                                ...
                                <div class="form-group">
                                    <label>Set ID</label>
                                    <input type="number" name="SetID" value="<?php echo isset($app['POST']['SetID'])?$app['POST']['SetID']:$batches->SetID;?>" class="form-control" placeholder="Enter SetID"> 
                                </div>
                                <div class="form-group">
