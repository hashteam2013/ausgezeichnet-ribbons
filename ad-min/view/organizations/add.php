        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-red-sunglo">
                    ...
                    <span class="caption-subject bold uppercase"> Add Organization</span>
                </div>
            ...
            <div class="portlet-body form">
                <div class="row">
                    <div class="col-sm-8">
                        <form role="form" action="<?php app_url('organizations','add','add');?>" method="POST">
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <select name="depart">
                                        ...
                                        <option value="<?php echo $depart['id']; ?>"><?php echo $depart['name_en'];  ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-actions">
                                    <button type="submit" name="add" class="btn blue">Add Organization</button>
