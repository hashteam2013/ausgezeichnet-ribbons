        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-red-sunglo">
                    ...
                    <span class="caption-subject bold uppercase"> Add Admin Account</span>
                </div>
                <div class="actions">
            ...
            <div class="portlet-body form">
                <div class="row">
                    <div class="col-sm-8">
                        <form role="form" action="<?php app_url('users','add','add');?>" method="POST">
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name='username' value="<?php echo isset($app['POST']['username'])?$app['POST']['username']:'';?>" class="form-control" placeholder="Username"> 
                                </div>  
                                <div class="form-group">
