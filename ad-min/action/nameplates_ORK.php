...
$limit = PAGE_CONTENT_LIMIT;
        ...
        $query_one->Where.= " where oi.product_id='1214' AND o.is_packing_made=0 AND o.is_order_valid=1 ORDER BY c.last_name, c.first_name";
...
$actual_lastname = "";
	...
	//	$pdf->Cell(78,18,'',1,0,'','','');
		...
		if(strlen($order_item->ShownName)>9)
		{
    ...
    $pdf->Output('', 'Offene Namensschilder ORK '.date('Y-m-d').'.pdf');
?>
