...
$limit = PAGE_CONTENT_LIMIT;
        ...
        $query_one->Where.= " where oi.product_id='1215' AND o.is_packing_made=0 AND o.is_order_valid=1 ORDER BY c.last_name, c.first_name";
...
$actual_lastname = "";
    ...
    $pdf->Output('', 'Offene Namensschilder BH Nagel '.date('Y-m-d').'.pdf');
?>
