                    ...
                    $(data).each(function (index, value) {
                        ...
                        $(value).each(function (i, v) {
                            ...
                            if (v.batch_image !== null) {
                                ...
                                if(v.ItemType!=='10'){
                                    cat_list += "<ul class='border border-[#b1b1b1] rounded-[10px] 2xl:p-5 p-3 cat_" + remove_id + "'><li class='ribbon_shop flex sm:flex-row flex-col 2xl:gap-5 gap-3'" + gray + "><div><img src=<?php echo DIR_WS_UPLOADS; ?>batch/" + v.batch_image + " class='2xl:max-w-[150px] lg:max-w-[100px] md:max-w-[70px] max-w-[80px]'></div><div class='flex-auto flex 2xl:gap-5 gap-3 xl:flex-row lg:flex-col md:flex-row flex-col justify-between'><div class='flex flex-col'><p class='mb-2.5 font-gothic text-black md:text-base text-sm break-normal'>" + v.webshop_title_en + "</p><div class='price_shop md:text-lg text-sm text-secondary font-normal'>EUR " + CurrencyFormatted(v.unit_price) + "</div><p class='text-black text-sm lg:max-w-[280px] w-full text-justify font-normal mt-1.5 prod-desc' >" + v.comment + "</p></div><div class='add-to-list'><input type='button' class='add-list font-medium px-5 cursor-pointer hover:bg-primary py-2.5 text-white bg-secondary rounded-md text-sm' " + disabledvalue + " value='" + valuebecome + "' data-batch-id='" + v.batch_id + "' data-batch-type=" + v.type + "></div></div> </li></ul>";
                                }
                                else{
                                    var cust_id = $("#custm").val();
                                    cat_list += "<ul class='border border-[#b1b1b1] rounded-[10px] p-5 cat_" + remove_id + "'><li class='ribbon_shop'" + gray + "><div><img src=<?php echo DIR_WS_UPLOADS; ?>batch/" + v.batch_image + " class='img-responsive'></div><div class='add-to-list'><input type='button' name='rename_cust'  data-toggle='modal' data-target='#Type10' onclick='RenameFunction(" + cust_id +", " + v.batch_id + ")' data-cid ='" + cust_id + "' class='add-list2'" + " value='" + valuebecome + "' data-batch-id='" + v.batch_id + "' data-batch-type=10></div><div class='price_shop'>EUR " + CurrencyFormatted(v.unit_price) + "</div><p>" + v.webshop_title_en + "</p><br><p class='text-black text-sm lg:max-w-[280px] w-full text-justify font-normal mt-1.5 prod-desc' >" + v.comment + "</p> </li></ul>";
                                }
                    ...
                    $(data).each(function (index, value) {
                        $(value).each(function (i, v) {
                            if (v.batch_image !== null) {
                                ...
                                var disabledvalue = v.is_active == '0' ? 'disabled' : '';
                                var valuebecome = v.is_active == '0' ? '<?php _e('Not Available'); ?>' : '<?php _e('Add to list'); ?>';
                                cat_list += "<ul class='dist-related border border-[#b1b1b1] rounded-[10px] 2xl:p-5 p-3  dist_" + dist_remove_id + "' ><li class='flex sm:flex-row flex-col 2xl:gap-5 gap-3 ribbon_shop' " + gray + "><div><img src=<?php echo DIR_WS_UPLOADS; ?>batch/" + v.batch_image + " class='2xl:max-w-[150px] lg:max-w-[100px] md:max-w-[70px] max-w-[80px]'></div><div class='flex-auto flex 2xl:gap-5 gap-3 xl:flex-row lg:flex-col md:flex-row flex-col justify-between'><div class='flex flex-col'><p class='mb-2.5 font-gothic text-black md:text-base text-sm break-normal'>" + v.webshop_title_en + "</p><div class='price_shop md:text-lg text-sm text-secondary font-normal'>EUR " + CurrencyFormatted(v.unit_price) + "</div><p class='text-black text-sm lg:max-w-[280px] w-full text-justify font-normal mt-1.5 prod-desc' >" + v.comment + "</p></div><div class='add-to-list '><input type='button' class='add-list font-medium px-5 cursor-pointer hover:bg-primary py-2.5 text-white bg-secondary rounded-md text-sm' " + disabledvalue + " value='" + valuebecome + "' data-batch-id='" + v.batch_id + "' data-batch-type=" + v.type + "></div></div> </li></ul>";
                                countt++;
                        ...
                        $(value).each(function (i, v) {
                            ...
                            if (v.batch_image !== null) {
                                ...
                                if (status != v.add_cat_sub_id && v.add_cat_sub_name !== null && v.add_cat_sub_name != '' && typeof v.add_cat_sub_name != "undefined") {
                                    ...
                                    cat_list += "<div class='conurty-nm bg-[#d9d9d9] justify-between text-base text-black font-normal rounded-[10px] px-5 2xl:py-0 py-1 inline-flex items-center w-full min-h-[46px] cat_" + remove_id + " contract '>" + add_cat_name + " <div class='plusminus'><svg width='18' height='18' viewBox='0 0 18 18' fill='none' xmlns='http://www.w3.org/2000/svg'><path d='M4.5 6.75L9 11.25L13.5 6.75' stroke='#343434' stroke-width='1.5' stroke-linecap='round' stroke-linejoin='round'/></svg></div> </div><div class='inner' style='display: none;'>";
                                    countt++;
                                }
                                ...
                                //console.log(valuebecome);
                                    ...
                                    if(v.ItemType!=='10')
                                    {
                                cat_list += "<ul class='border border-[#b1b1b1] rounded-[10px] 2xl:p-5 p-3 cat_" + remove_id + "'><li class='ribbon_shop flex sm:flex-row flex-col 2xl:gap-5 gap-3'" + gray + "><div><img src=<?php echo DIR_WS_UPLOADS; ?>batch/" + v.batch_image + " class='2xl:max-w-[150px] lg:max-w-[100px] md:max-w-[70px] max-w-[80px]'></div><div class='flex-auto xl:flex-row lg:flex-col md:flex-row flex-col flex 2xl:gap-5 gap-3 justify-between'><div class='flex flex-col'><p class='mb-2.5 font-gothic text-black md:text-base text-sm break-normal'>" + v.webshop_title_en + "</p><div class='price_shop md:text-lg text-sm text-secondary font-normal'>EUR " + CurrencyFormatted(v.unit_price) + "</div><p class='text-black text-sm lg:max-w-[280px] w-full text-justify font-normal mt-1.5 prod-desc' >" + v.comment + "</p></div><div class='add-to-list'><input type='button' class='add-list font-medium px-5 cursor-pointer hover:bg-primary py-2.5 text-white bg-secondary rounded-md text-sm' " + disabledvalue + " value='" + valuebecome + "' data-batch-id='" + v.batch_id + "' data-batch-type=" + v.type + "></div></div>  </li></ul>";
                                }
                                else
                                {
                                ...
                                cat_list += "<ul class='border border-[#b1b1b1] rounded-[10px] p-5 cat_" + remove_id + "'><li class='ribbon_shop flex sm:flex-row flex-col 2xl:gap-5 gap-3'" + gray + "><div><img src=<?php echo DIR_WS_UPLOADS; ?>batch/" + v.batch_image + " class='2xl:max-w-[150px] lg:max-w-[100px] md:max-w-[70px] max-w-[80px]'></div><div class='flex-auto xl:flex-row lg:flex-col md:flex-row flex-col flex 2xl:gap-5 gap-3 justify-between'><div class='flex flex-col'><p class='mb-2.5 font-gothic text-black md:text-base text-sm break-normal'>" + v.webshop_title_en + "</p><div class='price_shop md:text-lg text-base text-secondary font-normal'>EUR " + CurrencyFormatted(v.unit_price) + "</div><p class='text-black text-sm lg:max-w-[280px] w-full text-justify font-normal mt-1.5 prod-desc' >" + v.comment + "</p></div><div class='add-to-list'><input type='button' class='add-list font-medium px-5 cursor-pointer hover:bg-primary py-2.5 text-white bg-secondary rounded-md text-sm' " + disabledvalue + " value='" + valuebecome + "' data-batch-id='" + v.batch_id + "' data-batch-type=" + v.type + "></div></div>  </li></ul>";
            ...
            success: function (data) {
                ...
                if (data != '') {
                    ...
                    $(data).each(function (i, v) {
                        ...
                        var disabledvalue = v.is_active == '0' ? 'disabled' : '';
                        var valuebecome = v.is_active == '0' ? '<?php _e('Not Available'); ?>' : '<?php _e('Add to list'); ?>';
                        html += "<ul class='border border-[#b1b1b1] rounded-[10px] 2xl:p-5 p-3 search-out_" + count + "'><li class='flex 2xl:gap-5 gap-3' "+gray+"><div><img src=<?php echo DIR_WS_UPLOADS; ?>batch/" + v.batch_image + " class='2xl:max-w-[140px] md:max-w-[70px] max-w-[80px]'></div><div class='flex-auto xl:flex-row lg:flex-col md:flex-row flex-col flex 2xl:gap-5 gap-3 justify-between'><div class='flex flex-col'><p class='mb-2.5 font-gothic text-black md:text-base text-sm break-normal'>" + v.desc_en + "</p></div><div class='add-to-list'><input type='button' class='add-list font-medium px-5 cursor-pointer hover:bg-primary py-2.5 text-white bg-secondary rounded-md text-sm' " + disabledvalue + " value='" + valuebecome + "' data-batch-id='" + v.id + "' data-batch-type=" + v.type + "></div></div></li></ul>";
                    });
                    $(".list").prepend(html);
                } else {
