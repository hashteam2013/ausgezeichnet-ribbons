                    ...
                    $(data).each(function (index, value) {
                        ...
                        $(value).each(function (i, v) {
                            ...
                            if (v.batch_image !== null) {
                                ...
                                if(v.ItemType!=='10'){
                                    cat_list += "<ul class='border border-[#b1b1b1] rounded-[10px] 2xl:p-5 p-3 cat_" + remove_id + "'><li class='ribbon_shop flex sm:flex-row flex-col 2xl:gap-5 gap-3'" + gray + "><div><img src=<?php echo DIR_WS_UPLOADS; ?>batch/" + v.batch_image + " class='2xl:max-w-[150px] lg:max-w-[100px] md:max-w-[70px] max-w-[80px]'></div><div class='flex-auto flex 2xl:gap-5 gap-3 xl:flex-row lg:flex-col md:flex-row flex-col justify-between'><div class='flex flex-col'><p class='mb-2.5 font-gothic text-black md:text-base text-sm md:break-normal break-all'>" + v.webshop_title_en + "</p><div class='price_shop md:text-lg text-sm text-secondary font-normal'>EUR " + CurrencyFormatted(v.unit_price) + "</div><p class='text-black text-sm lg:max-w-[280px] w-full text-justify font-normal mt-1.5 prod-desc' >" + v.comment + "</p></div><div class='add-to-list'><input type='button' class='add-list font-medium px-5 cursor-pointer hover:bg-primary py-2.5 text-white bg-secondary rounded-md text-sm' " + disabledvalue + " value='" + valuebecome + "' data-batch-id='" + v.batch_id + "' data-batch-type=" + v.type + "></div></div> </li></ul>";
                                }
                                else{
                        ...
                        $(value).each(function (i, v) {
                            ...
                            if (v.batch_image !== null) {
                                ...
                                //console.log(valuebecome);
                                    ...
                                    if(v.ItemType!=='10')
                                    {
                                cat_list += "<ul class='border border-[#b1b1b1] rounded-[10px] 2xl:p-5 p-3 cat_" + remove_id + "'><li class='ribbon_shop flex sm:flex-row flex-col 2xl:gap-5 gap-3'" + gray + "><div><img src=<?php echo DIR_WS_UPLOADS; ?>batch/" + v.batch_image + " class='2xl:max-w-[150px] lg:max-w-[100px] md:max-w-[70px] max-w-[80px]'></div><div class='flex-auto xl:flex-row lg:flex-col md:flex-row flex-col flex 2xl:gap-5 gap-3 justify-between'><div class='flex flex-col'><p class='mb-2.5 font-gothic text-black md:text-base text-sm md:break-normal break-all'>" + v.webshop_title_en + "</p><div class='price_shop md:text-lg text-sm text-secondary font-normal'>EUR " + CurrencyFormatted(v.unit_price) + "</div><p class='text-black text-sm lg:max-w-[280px] w-full text-justify font-normal mt-1.5 prod-desc' >" + v.comment + "</p></div><div class='add-to-list'><input type='button' class='add-list font-medium px-5 cursor-pointer hover:bg-primary py-2.5 text-white bg-secondary rounded-md text-sm' " + disabledvalue + " value='" + valuebecome + "' data-batch-id='" + v.batch_id + "' data-batch-type=" + v.type + "></div></div>  </li></ul>";
                                }
                                else
                                {
                                ...
                                cat_list += "<ul class='border border-[#b1b1b1] rounded-[10px] p-5 cat_" + remove_id + "'><li class='ribbon_shop flex sm:flex-row flex-col 2xl:gap-5 gap-3'" + gray + "><div><img src=<?php echo DIR_WS_UPLOADS; ?>batch/" + v.batch_image + " class='2xl:max-w-[150px] lg:max-w-[100px] md:max-w-[70px] max-w-[80px]'></div><div class='flex-auto xl:flex-row lg:flex-col md:flex-row flex-col flex 2xl:gap-5 gap-3 justify-between'><div class='flex flex-col'><p class='mb-2.5 font-gothic text-black md:text-base text-sm md:break-normal break-all'>" + v.webshop_title_en + "</p><div class='price_shop md:text-lg text-base text-secondary font-normal'>EUR " + CurrencyFormatted(v.unit_price) + "</div><p class='text-black text-sm lg:max-w-[280px] w-full text-justify font-normal mt-1.5 prod-desc' >" + v.comment + "</p></div><div class='add-to-list'><input type='button' class='add-list font-medium px-5 cursor-pointer hover:bg-primary py-2.5 text-white bg-secondary rounded-md text-sm' " + disabledvalue + " value='" + valuebecome + "' data-batch-id='" + v.batch_id + "' data-batch-type=" + v.type + "></div></div>  </li></ul>";
            ...
            success: function (data) {
                ...
                if (data != '') {
                    ...
                    $(data).each(function (i, v) {
                        ...
                        var disabledvalue = v.is_active == '0' ? 'disabled' : '';
                        var valuebecome = v.is_active == '0' ? '<?php _e('Not Available'); ?>' : '<?php _e('Add to list'); ?>';
                        html += "<ul class='border border-[#b1b1b1] rounded-[10px] 2xl:p-5 p-3 search-out_" + count + "'><li class='flex 2xl:gap-5 gap-3' "+gray+"><div><img src=<?php echo DIR_WS_UPLOADS; ?>batch/" + v.batch_image + " class='2xl:max-w-[140px] md:max-w-[70px] max-w-[80px]'></div><div class='flex-auto xl:flex-row lg:flex-col md:flex-row flex-col flex 2xl:gap-5 gap-3 justify-between'><div class='flex flex-col'><p class='mb-2.5 font-gothic text-black md:text-base text-sm md:break-normal break-all'>" + v.desc_en + "</p></div><div class='add-to-list'><input type='button' class='add-list font-medium px-5 cursor-pointer hover:bg-primary py-2.5 text-white bg-secondary rounded-md text-sm' " + disabledvalue + " value='" + valuebecome + "' data-batch-id='" + v.id + "' data-batch-type=" + v.type + "></div></div></li></ul>";
                    });
                    $(".list").prepend(html);
                } else {
