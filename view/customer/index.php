...
<div class="flex flex-col md:py-20 py-5">
    <div class="ac-onword">
        <div class="container-custom">
            <div class="flex flex-col gap-5">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading flex items-center justify-between gap-2.5 mb-5">
                        <h3 class="panel-title md:text-3xl text-xl text-black font-gothic"><?php _e("Customers"); ?></h3>
                    ...
                    <div class="bg-body rounded-[20px] border border-[#d9d9d9] p-5 md:overflow-visible overflow-x-auto md:max-w-full max-w-[767px]">
                                ...
                                if (!empty($customers)) {
                                    foreach ($customers as $cust) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="border-b border-[#d9d9d9] md:py-4 py-2.5 text-secondary font-medium md:text-base text-sm pe-4"><?php echo $cust['first_name']; ?></td>
                                            <td class="border-b border-[#d9d9d9] md:py-4 py-2.5 text-secondary font-medium md:text-base text-sm pe-4"><?php echo $cust['last_name']; ?></td>
                                            <td class="border-b border-[#d9d9d9] md:py-4 py-2.5 text-secondary font-medium md:text-base text-sm pe-4">
                                                <span class="flex gap-2">
                                                    <span class="relative md:min-w-12 md:h-10 min-w-10 h-8 bg-white rounded-lg border border-[#d9d9d9] inline-flex justify-center items-center">
                                                        <svg width="20" height="20" class="pointer-events-none md:w-5 md:h-5 h-4 w-4" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
