                ...
                <form role="form" action="<?php echo make_url('change_password'); ?>" method="POST">
                    <div class="spot-a p-5 rounded-[20px] border border-[#d9d9d9] border-solid  flex flex-col">
                        ...
                        <div class="form-group">
                            <button type="submit" name="update" class="all-cat add-btn bg-secondary rounded-md px-5 min-h-10 text-sm text-white cursor-pointer font-medium"><?php _e("Update Password"); ?></button>
                        </div>
                    </div>
                </form>
            </div>
