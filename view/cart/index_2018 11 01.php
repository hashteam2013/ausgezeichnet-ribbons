	...
	<table class="col-md-12 table-bordered table-striped table-condensed cf">
                    ...
                    <tbody>
                            ...
                            if ($customer_name != $record['customer_name']) {
                                ...
                                foreach ($customer_items as $customer) {
                                    if ($customer->customer_id == $record['customer_id']) {
                                        ...
                                        echo 'F&uumlr diese Spange ben&oumltigen Sie ' . $LConnectors . ' L&aumlngsverbinder und ' . $QConnectors . ' Querverbinder. Wir empfehlen ' . $nails . ' N&aumlgel. Bitte passen Sie die St&uumlckzahlen im Warenkorb an. </td><td colspan="4"></td></tr>';
                                    }
                                }
                                $customer_name = $record['customer_name'];
                            }
                            echo '<tr id="p_'.$record['id'].'">';
                        ...
                        <tr>
                            ...
                            <td class="text-right"><h3><?php echo show_price(shipingCost(get_total() * (1 - $discount))); ?></h3></td>
                        </tr>
                        <tr>
                            <td  colspan="4" class="text-right"><h3><?php _e('TotalShipping'); ?></h3></td>
                            <td class="text-right"><h3><strong><?php echo show_price(get_total() * (1 - $discount) + shipingCost(get_total() * (1 - $discount))); ?></strong></h3></td>
                        </tr>
                        <tr>
                            ...
                            <td class="text-right"><h3><strong>
                                        ...
                                        if (get_discount_string() == '') {
                                            echo '3 Tage nach Zahlungseingang';
                                        } else {
                                            echo '3 Tage nach Zahlungseingang';
                                        }
                                        ?></strong></h3></td>
                        ...
                        <tr>
                            <td  colspan="6" class="text-right">
                                ...
                                <button type='submit' name='gotocheckout' class="btn cart-slct"><?php _e('Checkout'); ?> <i class="fa fa-angle-right"></i></button>
