...
<div class="container ac-onword">
                ...
                <form role="form" action="<?php make_url('orders'); ?>" method="POST">
                    <div class="spot-a">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <label><?php _e("Address2"); ?></label>
                                <input type="text" class="feild-a" name="address2" value="<?php echo isset($app['POST']['address2']) ? $app['POST']['address2'] : $app['user_info']->address2; ?>" placeholder="Hausnummer">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-6">
	...
	<div class="form-group">
		...
		if($msgWearAll!="")
		{
		echo '<select name="forcewearall" id="forcewearall">';
...
?>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                            <div class="col-sm-6">
                                <label><?php _e("Department2"); ?></label>
		  <label class="info-disc"><span><i class="fa fa-info-circle" aria-hidden="true"></i></span><font><?php _e("Department2Info"); ?></font></label>
                                <select name="org2">
			...
			{?>
                        ...
                        <div class="form-group">
                            <div class="col-sm-6">
                                <label><?php _e("State"); ?><font color="red">*</font></label>
