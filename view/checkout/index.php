    ...
    <div class="container">
        <div class="row">
                ...
                <div class="chech-out">
                    ...
                    <?php if ($user_detail->is_address_status == 1) { ?>
		                ...
		                <input type = "hidden" value="" name="countrychange" id="countrychange">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <label><?php _e("Address2"); ?><font color="red">*</font></label>
                                    <input type="text" class="feild-a" name='addr2' value="<?php echo $user_detail->address2; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <div class="col-sm-6">
                                    <label><?php _e("Country"); ?><font color="red">*</font></label>
                    ...
                    <?php } else { ?>
                        <div class="spot-a" id="billing_container" style="display:block">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <label><?php _e("Address2"); ?><font color="red">*</font></label>
                                    <input type="text" class="feild-a" name='addr2' value="<?php echo isset($app['POST']['addr2']) ? $app['POST']['addr2'] : $cart_detail->billing_address2; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-sm-6">
                    ...
                    <div class="spot-a" id="shipping_container" style="display:<?php echo $shipping_form; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <label><?php _e("Address2"); ?><font color="red">*</font></label>
                                <input type="text" class="feild-a" name='s_addr2' value="<?php echo isset($app['POST']['s_addr2']) ? $app['POST']['s_addr2'] : $cart_detail->shipping_address2; ?>">
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-6">
			...
			?>
                            ...
                            <tr class="total">
                                <td><?php _e("ShippingCost"); ?><br> <?php echo SHIPPING_COST_COMMENT;?></td>
                                <td class="area_shipping_cost"><?php show_price(shipingCostWithArea(get_total() * (1 - $cart_detail->discount),$area)); ?></td>
                            </tr>
                            <tr>
                                <td><h4><strong><?php _e('TotalShipping'); ?></strong></h4>	 </td>
                                <td><h4><strong class="total_amnt_shipping_cost"><?php echo show_price(get_total() * (1 - $cart_detail->discount) + shipingCostWithArea(get_total() * (1 - $cart_detail->discount),$area)); ?></strong></h4></td>
                            </tr>
                            <tr>
                                <td><h4><strong><?php echo SHIPPING_TIME_TITLE?></strong></h4></td>
                                <td><h4><strong><?php echo SHIPPING_TIME_VALUE?></h4></td>
                            </tr>
                            ...
                            <?php if (PAYMENT_GATEWAYS == 'Both') { ?>
                                <tr>
                                    ...
                                    <td style="padding-left: 30px;">
                                        ...
                                        <label class="radio">
                                            <input type="radio"<?php echo (DEFAULT_PAYMENT_GATEWAY == 'Sofort') ? "checked" : "" ?>  name="payment_gateway" value="Sofort" disabled="disabled"/> Sofort - aus technischen Gründen derzeit nicht verfügbar
                                        </label>
                                        <label class="radio">
