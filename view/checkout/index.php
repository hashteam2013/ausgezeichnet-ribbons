...
<div class="flex w-full md:py-20 py-5">
    <div class="container-custom">
            ...
            <div class="flex flex-col lg:w-2/3 w-full">
                ...
                <div class="p-5 rounded-[20px] border border-[#d9d9d9] border-solid  flex flex-col md:mb-14 mb-5">
                        ...
                        <?php if ($user_detail->is_address_status == 1) { ?>
                            <div class="spot-a" id="billing_container" style="display:block">
                                ...
                                <div class="form-group mb-7 flex flex-col gap-2.5">
                                    ...
                                    <input type="text"
                                        class="feild-a min-h-[46px] bg-white px-4 text-base text-black border border-solid border-[#d9d9d9] focus:outline-none rounded-[10px]"
                                        name='company' value="<?php echo $user_detail->company; ?>">
                                </div>

                                <div class="form-group mb-7 flex flex-col gap-2.5">
                                    <label class="text-base font-medium text-dark"><?php _e("First Name"); ?>
                                        <font color="red">*</font>
                                    </label>
                                    <input type="text"
                                        class="feild-a min-h-[46px] bg-white px-4 text-base text-black border border-solid border-[#d9d9d9] focus:outline-none rounded-[10px]"
                                        name='fname' value="<?php echo $user_detail->first_name; ?>">
                                </div>

                                <div class="form-group mb-7 flex flex-col gap-2.5">
                                    <label class="text-base font-medium text-dark"><?php _e("Last Name"); ?>
                                        <font color="red">*</font>
                                    </label>
                                    <input type="text"
                                        class="feild-a min-h-[46px] bg-white px-4 text-base text-black border border-solid border-[#d9d9d9] focus:outline-none rounded-[10px]"
                                        name='lname' value="<?php echo $user_detail->last_name; ?>">
                                </div>


                                <div class="form-group mb-7 flex flex-col gap-2.5">
                                    <label class="text-base font-medium text-dark"><?php _e("Phone No."); ?>
                                        <font color="red">*</font>
                                    </label>
                                    <input type="tel"
                                        class="feild-a min-h-[46px] bg-white px-4 text-base text-black border border-solid border-[#d9d9d9] focus:outline-none rounded-[10px]"
                                        name='phone' value="<?php echo $user_detail->phone; ?>">
                                </div>

                                <div class="form-group mb-7 flex flex-col gap-2.5">
                                    <label class="text-base font-medium text-dark"><?php _e("Email Address"); ?>
                                        <font color="red">*</font>
                                    </label>
                                    <input type="email"
                                        class="feild-a min-h-[46px] bg-white px-4 text-base text-black border border-solid border-[#d9d9d9] focus:outline-none rounded-[10px]"
                                        name='email' value="<?php echo $user_detail->email; ?>">
                                </div>

                                <div class="form-group mb-7 flex flex-col gap-2.5">
                                    <label class="text-base font-medium text-dark"><?php _e("Address"); ?>
                                        <font color="red">*</font>
                                    </label>
                                    <input type="text"
                                        class="feild-a min-h-[46px] bg-white px-4 text-base text-black border border-solid border-[#d9d9d9] focus:outline-none rounded-[10px]"
                                        name='addr' value="<?php echo $user_detail->address1; ?>">
                                </div>

                                <div class="form-group mb-7 flex flex-col gap-2.5">
                                    <label class="text-base font-medium text-dark"><?php _e("Address2"); ?>
                                        <font color="red">*</font>
                                    </label>
                                    <input type="text"
                                        class="feild-a min-h-[46px] bg-white px-4 text-base text-black border border-solid border-[#d9d9d9] focus:outline-none rounded-[10px]"
                                        name='addr2' value="<?php echo $user_detail->address2; ?>">
                                </div>

                                <div class="form-group mb-7 flex flex-col gap-2.5">
                                    <label class="text-base font-medium text-dark"><?php _e("Zip Code"); ?>
                                        <font color="red">*</font>
                                    </label>
                                    <input type="text"
                                        class="feild-a min-h-[46px] bg-white px-4 text-base text-black border border-solid border-[#d9d9d9] focus:outline-none rounded-[10px]"
                                        name='zip' value="<?php echo $user_detail->zipcode; ?>">
                                </div>

                                <div class="form-group mb-7 flex flex-col gap-2.5">
                                    <label class="text-base font-medium text-dark"><?php _e("Town / City"); ?>
                                        <font color="red">*</font>
                                    </label>
                                    <input type="text"
                                        class="feild-a min-h-[46px] bg-white px-4 text-base text-black border border-solid border-[#d9d9d9] focus:outline-none rounded-[10px]"
                                        name='city' value="<?php echo $user_detail->city; ?>">
                                </div>

                                <div class="form-group mb-7 flex flex-col gap-2.5">
                                    <label class="text-base font-medium text-dark"><?php _e("Country"); ?>
                                        <font color="red">*</font>
                                    </label>
                                    <select name="country" id="country"
                                        class="country min-h-[46px] bg-white px-4 text-base text-black border border-solid border-[#d9d9d9] focus:outline-none rounded-[10px]">
                                        <option value=1 <?php echo ($user_detail->district != 30) ? 'selected' : '' ?>>
                                            Österreich</option>
                                        <option value=2 <?php echo ($user_detail->district == 30) ? 'selected' : '' ?>>
                                            Deutschland</option>
                                    </select>
                                </div>
                                ...
                                <div class="form-group flex gap-2.5">
                                    <label class="flex items-center gap-2.5 green_label relative">
                                        <input type="checkbox" <?php echo ($shipping_form == 'none') ? "checked" : ""; ?>
                                            name="shipping_check" class="cc-hh opacity-0 absolute z-[1] left-0 w-4 h-4"
                                            id="ship">
                                        <span
                                            class="sm_checkmark  relative w-4 h-4 inline-flex border border-solid border-[#b1b1b1] rounded-[3px] "></span>
                                        <p class="text-sm font-medium text-black/55"><?php _e("Same billing shipping"); ?>
                                        </p>
                                    </label>
                                </div>
                            </div>
                        ...
                        <div class="spot-a mt-7" id="billing_container" style="display:block">
                            ...
                            <div class="form-group mb-7 flex flex-col gap-2.5">
                                ...
                                <input type="text"
                                    class="feild-a min-h-[46px] bg-white px-4 text-base text-black border border-solid border-[#d9d9d9] focus:outline-none rounded-[10px]"
                                    name='company'
                                    value="<?php echo isset($app['POST']['company']) ? $app['POST']['company'] : $cart_detail->billing_company; ?>">
                            </div>
                            ...
                            <div class="form-group mb-7 flex flex-col gap-2.5">
                                ...
                                <input type="text"
                                    class="feild-a min-h-[46px] bg-white px-4 text-base text-black border border-solid border-[#d9d9d9] focus:outline-none rounded-[10px]"
                                    name='fname'
                                    value="<?php echo isset($app['POST']['fname']) ? $app['POST']['fname'] : $cart_detail->billing_firstname; ?>">
                            </div>
                            ...
                            <div class="form-group mb-7 flex flex-col gap-2.5">
                                ...
                                <input type="text"
                                    class="feild-a min-h-[46px] bg-white px-4 text-base text-black border border-solid border-[#d9d9d9] focus:outline-none rounded-[10px]"
                                    name='lname'
                                    value="<?php echo isset($app['POST']['lname']) ? $app['POST']['lname'] : $cart_detail->billing_lastname; ?>">
                            </div>
                            ...
                            <div class="form-group mb-7 flex flex-col gap-2.5">
                                ...
                                <input type="tel"
                                    class="feild-a min-h-[46px] bg-white px-4 text-base text-black border border-solid border-[#d9d9d9] focus:outline-none rounded-[10px]"
                                    name='phone'
                                    value="<?php echo isset($app['POST']['phone']) ? $app['POST']['phone'] : $cart_detail->billing_mobile; ?>">
                            </div>
                            ...
                            <div class="form-group mb-7 flex flex-col gap-2.5">
                                ...
                                <input type="email"
                                    class="feild-a min-h-[46px] bg-white px-4 text-base text-black border border-solid border-[#d9d9d9] focus:outline-none rounded-[10px]"
                                    name='email'
                                    value="<?php echo isset($app['POST']['email']) ? $app['POST']['email'] : $cart_detail->billing_email; ?>">
                            </div>
                            ...
                            <div class="form-group mb-7 flex flex-col gap-2.5">
                                ...
                                <input type="text"
                                    class="feild-a min-h-[46px] bg-white px-4 text-base text-black border border-solid border-[#d9d9d9] focus:outline-none rounded-[10px]"
                                    name='addr'
                                    value="<?php echo isset($app['POST']['addr']) ? $app['POST']['addr'] : $cart_detail->billing_address1; ?>">
                            </div>
                            ...
                            <div class="form-group mb-7 flex flex-col gap-2.5">
                                ...
                                <input type="text"
                                    class="feild-a min-h-[46px] bg-white px-4 text-base text-black border border-solid border-[#d9d9d9] focus:outline-none rounded-[10px]"
                                    name='addr2'
                                    value="<?php echo isset($app['POST']['addr2']) ? $app['POST']['addr2'] : $cart_detail->billing_address2; ?>">
                            </div>
                            ...
                            <div class="form-group mb-7 flex flex-col gap-2.5">
                                ...
                                <input type="text"
                                    class="feild-a min-h-[46px] bg-white px-4 text-base text-black border border-solid border-[#d9d9d9] focus:outline-none rounded-[10px]"
                                    name='zip'
                                    value="<?php echo isset($app['POST']['zip']) ? $app['POST']['zip'] : $cart_detail->billing_zip; ?>">
                            </div>
                            ...
                            <div class="form-group mb-7 flex flex-col gap-2.5">
                                ...
                                <input type="text"
                                    class="feild-a min-h-[46px] bg-white px-4 text-base text-black border border-solid border-[#d9d9d9] focus:outline-none rounded-[10px]"
                                    name='city'
                                    value="<?php echo isset($app['POST']['city']) ? $app['POST']['city'] : $cart_detail->billing_city; ?>">
                            </div>
                            ...
                            <div class="form-group flex gap-2.5">
                                <label class="flex items-center gap-2.5 green_label relative">
                                    <input type="checkbox" <?php echo ($shipping_form == 'none') ? "checked" : ""; ?>
                                        name="shipping_check" class="cc-hh" id="ship">
                                    <span
                                        class="sm_checkmark relative w-4 h-4 inline-flex border border-solid border-[#b1b1b1] rounded-[3px]"></span>
                    ...
                    <div class="spot-a mt-7" id="shipping_container" style="display:<?php echo $shipping_form; ?>">
                        <h3 class="md:text-3xl text-xl text-black font-gothic mb-5">
                            <?php _e("Shipping Details"); ?>
                        </h3>

                        <div class="form-group mb-7 flex flex-col gap-2.5">
                            <label class="text-base font-medium text-dark">
                                <?php _e("Company"); ?>
                            </label>
                            <input type="text"
                                class="feild-a min-h-[46px] bg-white px-4 text-base text-black border border-solid border-[#d9d9d9] focus:outline-none rounded-[10px]"
                                name='s_company'
                                value="<?php echo isset($app['POST']['s_company']) ? $app['POST']['s_company'] : $cart_detail->billing_company; ?>">
                        </div>
                        ...
                        <div class="form-group mb-7 flex flex-col gap-2.5">
                            ...
                            <input type="text"
                                class="feild-a min-h-[46px] bg-white px-4 text-base text-black border border-solid border-[#d9d9d9] focus:outline-none rounded-[10px]"
                                name='s_fname'
                                value="<?php echo isset($app['POST']['s_fname']) ? $app['POST']['s_fname'] : $cart_detail->shipping_firstname; ?>">
                        </div>
                        ...
                        <div class="form-group mb-7 flex flex-col gap-2.5">
                            ...
                            <input type="text"
                                class="feild-a min-h-[46px] bg-white px-4 text-base text-black border border-solid border-[#d9d9d9] focus:outline-none rounded-[10px]"
                                name='s_lname'
                                value="<?php echo isset($app['POST']['s_lname']) ? $app['POST']['s_lname'] : $cart_detail->shipping_lastname; ?>">
                        </div>
                        ...
                        <div class="form-group mb-7 flex flex-col gap-2.5">
                            ...
                            <input type="tel"
                                class="feild-a min-h-[46px] bg-white px-4 text-base text-black border border-solid border-[#d9d9d9] focus:outline-none rounded-[10px]"
                                name='s_phone'
                                value="<?php echo isset($app['POST']['s_phone']) ? $app['POST']['s_phone'] : $cart_detail->shipping_mobile; ?>">
                        </div>
                        ...
                        <div class="form-group mb-7 flex flex-col gap-2.5">
                            ...
                            <input type="email"
                                class="feild-a min-h-[46px] bg-white px-4 text-base text-black border border-solid border-[#d9d9d9] focus:outline-none rounded-[10px]"
                                name='s_email'
                                value="<?php echo isset($app['POST']['s_email']) ? $app['POST']['s_email'] : $cart_detail->shipping_email; ?>">
                        </div>
                        ...
                        <div class="form-group mb-7 flex flex-col gap-2.5">
                            ...
                            <input type="text"
                                class="feild-a min-h-[46px] bg-white px-4 text-base text-black border border-solid border-[#d9d9d9] focus:outline-none rounded-[10px]"
                                name='s_addr'
                                value="<?php echo isset($app['POST']['s_addr']) ? $app['POST']['s_addr'] : $cart_detail->shipping_address1; ?>">
                        </div>
                        ...
                        <div class="form-group mb-7 flex flex-col gap-2.5">
                            ...
                            <input type="text"
                                class="feild-a min-h-[46px] bg-white px-4 text-base text-black border border-solid border-[#d9d9d9] focus:outline-none rounded-[10px]"
                                name='s_addr2'
                                value="<?php echo isset($app['POST']['s_addr2']) ? $app['POST']['s_addr2'] : $cart_detail->shipping_address2; ?>">
                        </div>
                        ...
                        <div class="form-group mb-7 flex flex-col gap-2.5">
                            ...
                            <input type="text"
                                class="feild-a min-h-[46px] bg-white px-4 text-base text-black border border-solid border-[#d9d9d9] focus:outline-none rounded-[10px]"
                                name='s_zip'
                                value="<?php echo isset($app['POST']['s_zip']) ? $app['POST']['s_zip'] : $cart_detail->shipping_zip; ?>">
                        </div>
                        ...
                        <div class="form-group flex flex-col gap-2.5">
                            ...
                            <input type="text"
                                class="feild-a min-h-[46px] bg-white px-4 text-base text-black border border-solid border-[#d9d9d9] focus:outline-none rounded-[10px]"
                                name='s_city'
                                value="<?php echo isset($app['POST']['s_city']) ? $app['POST']['s_city'] : $cart_detail->shipping_city; ?>">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group flex flex-col gap-5">
                    ...
                    <textarea name="order_comment"
                        class="feild-a pt-4 min-h-28 bg-white px-4 text-base text-black border border-solid border-[#d9d9d9] focus:outline-none rounded-[10px]"
                        id="order_comm"
                ...
                <div class="flex flex-col gap-5">
                    <h3 class="md:text-3xl text-xl text-black font-gothic flex items-center justify-between">
                        ...
                        <a href="<?php echo make_url("cart"); ?>" class="pull-right" title="Update Order">
                            <svg width="20" height="20" class="pointer-events-none" viewBox="0 0 20 20" fill="none"
                                ...
                                <g clip-path="url(#clip0_714_1751)">
                                    <path
                                        ...
                                        stroke="#393C40" stroke-width="1.5" stroke-linecap="round"
