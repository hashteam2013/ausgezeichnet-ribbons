                    ...
                    <div class="y-order">
                        ...
                        <table>
                            ...
                            <tr class="total">
                                ...
                                <td><?php show_price(shipingCostWithArea(get_total() * (1 - $cart_detail->discount),$area)); ?></td>
                            </tr>
                            <tr>
                                <td><h4><strong><?php _e('TotalShipping'); ?></strong></h4>	 </td>
                                <td><h4><strong><?php echo show_price(get_total() * (1 - $cart_detail->discount) + shipingCostWithArea(get_total() * (1 - $cart_detail->discount),$area)); ?></strong></h4></td>
                            </tr>
                            <tr>
